...
class Swinger(object):
    ...
    def swing(self, sentence):
        ...
        # first word positive, the second is negative
        return self.classifier.prob_classify_many(sentence)[0].prob('pos'), self.classifier.prob_classify_many(sentence)[0].prob('neg')
